...
\begin{description}
    \item[setlength] Ajusta medidas (ex: espaçamento entre parágrafos com \texttt{\textbackslash setlength\{\textbackslash parskip\}\{0.6em\}}).
    \item[author] Define o autor (\texttt{\textbackslash author\{...\}}).
    \item[title] Define o título (\texttt{\textbackslash title\{...\}}).
\end{description}
