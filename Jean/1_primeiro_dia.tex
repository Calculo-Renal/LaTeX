...
\begin{description}
    \item[setlength] O comando \texttt{\textbackslash{}setlength\{\emph{size}\}} permite dar tamanho para macros que são espaços como \texttt{\textbackslash{}parskip} ao colocar um valor de tamanho em \texttt{size}.
    \item[author] O comando \texttt{\textbackslash{}author\{\emph{name}\}} permite definir um autor para o documento ao colocar um texto em \texttt{name}.
    \item[title] \texttt{\textbackslash{}title\{\emph{name}\}} permite definir um título para o documento ao colocar um texto em \texttt{name}.
\end{description}
